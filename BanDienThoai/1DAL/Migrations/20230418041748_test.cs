    ...
    public partial class test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Hà Nam", 1, 1, new DateTime(2023, 4, 18, 11, 17, 48, 230, DateTimeKind.Local).AddTicks(1886), "0336253482", "Ngô Quốc Mạnh", 0, "123" });

            migrationBuilder.InsertData(
                table: "NhanVien",
                columns: new[] { "MaNV", "DiaChi", "GioiTinh", "MaCV", "NgaySinh", "SDT", "TenNV", "TrangThai", "matKhau" },
                values: new object[] { 2, "Tuyên Quang", 1, 2, new DateTime(2023, 4, 18, 11, 17, 48, 230, DateTimeKind.Local).AddTicks(1877), "0379702133", "Nguyễn Văn Đạo", 0, "123" });
